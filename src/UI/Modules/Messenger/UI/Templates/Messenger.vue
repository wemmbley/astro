...
<!--                placeholder="Поиск среди диалогов..."/>-->
        ...
        <div class="flex flex-col flex-1 min-w-0">
            ...
            <template v-else>
                ...
                <div class="p-3 border-t border-r border-b border-white/10 relative flex items-end gap-2">
                    <textarea
                        autofocus
                        v-model="messageText"
...
<!--                    <SmileBox :insertSmilesTo="insertSmile" />-->
                    <button @click="sendMessage"
                            class="p-2 rounded-md hover:scale-110 hover:text-accent
                            transition shrink-0 cursor-pointer -translate-y-2">
                        <Send :size="18" />
                    </button>
                </div>
            </template>
