...
final class PythonResponseMapper
{
    public static function map(array $payload): Natal
    {
        return new Natal(
            planets: self::mapPlanets(
                $payload['planets']
            ),

            houses: self::mapHouses(
                $payload['houses']
            ),

            elements: self::mapElements(
                $payload['alchemy']['elements']
            ),

            dominantSign: self::mapSign(
                $payload['alchemy']['dominant_sign']
            ),
